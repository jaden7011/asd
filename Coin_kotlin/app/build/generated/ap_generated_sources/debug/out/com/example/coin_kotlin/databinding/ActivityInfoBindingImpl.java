...
public class ActivityInfoBindingImpl extends ActivityInfoBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.User == variableId) {
            setUser((com.example.coin_kotlin.info.User) variable);
        }
        else if (BR.infoActivity == variableId) {
            setInfoActivity((com.example.coin_kotlin.infoactivity.InfoActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUser(@Nullable com.example.coin_kotlin.info.User User) {
        this.mUser = User;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    public void setInfoActivity(@Nullable com.example.coin_kotlin.infoactivity.InfoActivity InfoActivity) {
    ...
    protected void executeBindings() {
        ...
        com.example.coin_kotlin.info.User user = mUser;
