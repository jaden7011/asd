...
public class ActivityPostBindingImpl extends ActivityPostBinding  {
    ...
    private ActivityPostBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (bindings[8] != null) ? com.example.coin_kotlin.databinding.ViewLoaderBinding.bind((android.view.View) bindings[8]) : null
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.Post == variableId) {
            setPost((com.example.coin_kotlin.info.Post) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setPost(@Nullable com.example.coin_kotlin.info.Post Post) {
        this.mPost = Post;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.example.coin_kotlin.info.Post post = mPost;
