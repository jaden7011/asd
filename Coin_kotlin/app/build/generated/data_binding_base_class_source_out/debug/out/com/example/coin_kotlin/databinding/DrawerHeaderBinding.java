...
public final class DrawerHeaderBinding implements ViewBinding {
  ...
  private DrawerHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView mailT,
      @NonNull TextView nameT) {
  ...
  public static DrawerHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.mail_T;
      TextView mailT = ViewBindings.findChildViewById(rootView, id);
      if (mailT == null) {
        break missingId;
      }
      ...
      return new DrawerHeaderBinding((LinearLayout) rootView, mailT, nameT);
    }
